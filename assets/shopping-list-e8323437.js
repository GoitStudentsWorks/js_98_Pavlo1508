import{b as m,c as p}from"./dark-9d3b31af.js";const k="data:image/png;base64,",A="/js_98_Pavlo1508/assets/IMG_96061-729edc7b.png",c=document.getElementById("theme");function g(){const s=document.querySelector(".hero-title"),o=document.querySelector(".sidebar");s.textContent==="Shopping List"&&(o.style.display="none")}g();const i=document.querySelector(".shopping-list"),u=localStorage.getItem("booksData"),r=b();function b(){let s;try{return s=JSON.parse(u),s}catch(o){return console.error("Error:",o),null}}function h(s){const o=s.map(e=>`<li class="sl-item" data-bookId="${e._id}">
