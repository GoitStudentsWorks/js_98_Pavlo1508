import{a as k,b as E,c as T}from"./dark-9d3b31af.js";const L=document.querySelector("#theme");let v=null;async function A(){if(!v)try{v=(await k.get("https://books-backend.p.goit.global/books/top-books")).data}catch(e){throw console.error(e),e}return v}function M(e){const{_id:o,author:t,book_image:a,title:c}=e;return`
